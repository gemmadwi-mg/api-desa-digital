...
class SocialAssistanceRecipientController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Penerima Bantuan Sosial Berhasil Berhasil Diambil', SocialAssistanceRecipientResource::collection($socialAssistanceRecipients), 200);
        } catch (\Exception $e) {
